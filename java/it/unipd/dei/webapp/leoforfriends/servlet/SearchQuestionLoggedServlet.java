...
public final class SearchQuestionLoggedServlet extends AbstractDatabaseServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			if (userInput == null || userInput.equals("")){
				...
				req.getRequestDispatcher("/jsp/search-question-result-logged.jsp").forward(req, res);
			}
