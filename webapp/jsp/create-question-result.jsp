...
<html lang="en">
	...
	<body>
		...
		<div class="cont">
			<div class="int">
				<div id="res">
					<!-- display  created question, if any and no errors -->
					<c:if test='${not empty question && !message.error}'>
						<h1>
							Question created successfully!
						</h1>
						<ul>
							<li>Title: <c:out value="${question.title}"/></li>
							<li>Content: <c:out value="${question.content}"/></li>
						</ul>
						<p>
							<a href="/leoforfriends-1.00/jsp/question-page-logged.jsp?value=<c:out value="${question.id}"/>">Go to the question page</a>
					</c:if>
					<c:if test='${message.error}'>
						<p class="error_content">
							...
							<a href="/leoforfriends-1.00/jsp/create-question-form.jsp">Return to the create question page</a>
						</p>
					</c:if>
				</div>
			</div>
