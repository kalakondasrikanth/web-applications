...
<html lang="en" >
	<head>
		<meta charset="UTF-8">
		<title>Login</title>
		<link rel="stylesheet" href="/leoforfriends-1.00/css/register-login-redirect.css">
	...
	<body>
		...
		<div class="cont">
			<div class="int">
				<div class="login">
					<div class="login_row">
						<p class="top_content"><b>You must be logged in </br> to view this content.</b> &nbsp;</p>
					</div>
					<div class="login__row">
						<p class="login__content">If you have an account, please &nbsp;<a href="/leoforfriends-1.00/jsp/login.jsp">Log in</a></p>
					</div>
					<div class="register__row">
						<p class="register__content">Don't have an account? &nbsp;<a href="/leoforfriends-1.00/jsp/registration.jsp">Register</a></p>
					</div>
				</div>
			</div>
		</div>
