...
/**
 * Manages the connections to the data source
 *
...
public abstract class AbstractDatabaseServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        try {
            ...
            ds = (DataSource) cxt.lookup("java:/comp/env/jdbc/leoforfriends");
    ...
    /**
     * Alternative to the previous method with the same name exploited by the Filter.
     * Gets the {@code DataSource} for managing the connection pool to the database.
     *
     * @param config
     *          a {@code FilterConfig} object containing the filter's
     *          configuration and initialization parameters.
     *
     * @throws ServletException
     *          if an exception has occurred that interferes with the servlet's normal operation
